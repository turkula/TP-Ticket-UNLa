...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        function defaultProgressBar(obj, s) {
            ...
            this.done.addClass("btn btn-default btn-sm");
            this.download.addClass("btn btn-default btn-sm");
            this.cancel.addClass("btn btn-default btn-sm");
            this.del.addClass("btn btn-default btn-sm");
            this.download.css("margin-bottom", '25px');
            this.del.css("margin-bottom", '25px');
            this.abort.css("margin-bottom", '25px');
            this.done.css("margin-bottom", '25px');
            this.cancel.css("margin-bottom", '25px');
            this.del.css("margin-left", '5px');
